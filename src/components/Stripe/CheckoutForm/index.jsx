...
export function CheckoutForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!stripe || !elements) {
      console.error(" Strip ou elemento não encontrado");
      return;
    }
      ...
      toast.error(error.message)
         ...
         try {
            ...
            if (status === 200 || status === 201) { 
                ...
                toast.success('Pedido Realizado com sucesso!'); // Mensagem de sucesso
            } else if (status === 409) {              // Caso de email já cadastrado
                toast.error('Falha ao reazilar o seu pedido.');
    ...
    <div className="container">
      ...
      <div id="dpm-annotation">
        ...
        Os métodos de pagamento são disponibilizados de acordo com sua região.&nbsp;
          <a href={dpmCheckerLink} target="_blank" rel="noopener noreferrer" id="dpm-integration-checker" >Ver métados de Pagamentos </a>
        </p>
      </div>
    </div>
  );
